...
The MCP server lives in the **[stubborn-mcp](https://github.com/stubborn-ai/stubborn-mcp)** repository — not in this package.
...
- [stubborn-mcp docs/MCP.md](https://github.com/stubborn-ai/stubborn-mcp/blob/main/docs/MCP.md)
